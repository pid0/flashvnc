...
nnoremap -N :cprevious
nnoremap -n :cnext
nnoremap -g :execute "silent grep! -R " . shellescape(expand("<cWORD>")) . " .":copen
nnoremap -C :match none:nohlsearch
nnoremap -w :match Error /\v\s+$/
nnoremap -c :execute ":make " . b:make_build_arg
nnoremap -v :call b:CustomTestCurrentFunc()
nnoremap -V :call b:CustomTestAllFunc()
nnoremap -' ea'bi'lel
...
iabbr adn and
iabbr abaout about
iabbr pybang #!/usr/bin/env python
iabbr shbang #!/usr/bin/env bash
let &cpo=s:cpo_save
unlet s:cpo_save
...
silent only
cd /net/pa/dynamic/development/software/repos/flashvnc/client
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 tests/end_to_end_spec.rs
badd +5 src/main.rs
badd +1 atspi.py
badd +15 Cargo.toml
badd +82 tests/acceptance_spec.rs
badd +4 src/lib.rs
badd +3 src/protocol/rfb.rs
badd +1 src/protocol/mod.rs
badd +221 src/protocol/parsing/packet.rs
badd +79 src/protocol/parsing/mod.rs
badd +1 src/protocol/parsing/primitive.rs
badd +1 src/bin/server_test_program.rs
badd +8 src/protocol/parsing/io_input.rs
badd +1 src/protocol/parsing/result.rs
badd +6 src/protocol/parsing/parser_test.rs
argglobal
silent! argdel *
set stal=2
edit tests/end_to_end_spec.rs
...
exe 'vert 1resize ' . ((&columns * 95 + 255) / 511)
exe 'vert 2resize ' . ((&columns * 95 + 255) / 511)
exe 'vert 3resize ' . ((&columns * 95 + 255) / 511)
exe 'vert 4resize ' . ((&columns * 95 + 255) / 511)
exe 'vert 5resize ' . ((&columns * 127 + 255) / 511)
argglobal
...
247
normal! zo
let s:l = 250 - ((43 * winheight(0) + 22) / 45)
...
wincmd w
argglobal
if bufexists('src/bin/server_test_program.rs') | buffer src/bin/server_test_program.rs | else | edit src/bin/server_test_program.rs | endif
nnoremap <buffer> <D-R> :RustRun! =join(b:rust_last_rustc_args)erust#AppendCmdLine(' -- ' . join(b:rust_last_args))
nnoremap <buffer> <silent> <D-r> :RustRun
onoremap <buffer> <silent> [[ :call rust#Jump('o', 'Back')
xnoremap <buffer> <silent> [[ :call rust#Jump('v', 'Back')
...
49
normal! zo
let s:l = 49 - ((9 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
wincmd w
argglobal
if bufexists('tests/acceptance_spec.rs') | buffer tests/acceptance_spec.rs | else | edit tests/acceptance_spec.rs | endif
nnoremap <buffer> <D-R> :RustRun! =join(b:rust_last_rustc_args)erust#AppendCmdLine(' -- ' . join(b:rust_last_args))
nnoremap <buffer> <silent> <D-r> :RustRun
onoremap <buffer> <silent> [[ :call rust#Jump('o', 'Back')
xnoremap <buffer> <silent> [[ :call rust#Jump('v', 'Back')
...
206
normal! zo
let s:l = 220 - ((39 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
220
...
wincmd w
argglobal
if bufexists('src/lib.rs') | buffer src/lib.rs | else | edit src/lib.rs | endif
nnoremap <buffer> <D-R> :RustRun! =join(b:rust_last_rustc_args)erust#AppendCmdLine(' -- ' . join(b:rust_last_args))
nnoremap <buffer> <silent> <D-r> :RustRun
onoremap <buffer> <silent> [[ :call rust#Jump('o', 'Back')
xnoremap <buffer> <silent> [[ :call rust#Jump('v', 'Back')
...
385
normal! zo
let s:l = 235 - ((36 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
235
...
wincmd w
argglobal
if bufexists('atspi.py') | buffer atspi.py | else | edit atspi.py | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
106
normal! zo
let s:l = 105 - ((23 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
105
...
exe 'vert 4resize ' . ((&columns * 95 + 255) / 511)
exe 'vert 5resize ' . ((&columns * 127 + 255) / 511)
tabedit src/protocol/parsing/result.rs
set splitbelow splitright
wincmd _ | wincmd |
vsplit
wincmd _ | wincmd |
...
65
normal! zo
let s:l = 10 - ((8 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
10
...
wincmd w
argglobal
if bufexists('src/protocol/parsing/mod.rs') | buffer src/protocol/parsing/mod.rs | else | edit src/protocol/parsing/mod.rs | endif
nnoremap <buffer> <D-R> :RustRun! =join(b:rust_last_rustc_args)erust#AppendCmdLine(' -- ' . join(b:rust_last_args))
nnoremap <buffer> <silent> <D-r> :RustRun
onoremap <buffer> <silent> [[ :call rust#Jump('o', 'Back')
xnoremap <buffer> <silent> [[ :call rust#Jump('v', 'Back')
...
77
normal! zo
let s:l = 70 - ((24 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
70
...
wincmd w
argglobal
if bufexists('src/protocol/parsing/packet.rs') | buffer src/protocol/parsing/packet.rs | else | edit src/protocol/parsing/packet.rs | endif
nnoremap <buffer> <D-R> :RustRun! =join(b:rust_last_rustc_args)erust#AppendCmdLine(' -- ' . join(b:rust_last_args))
nnoremap <buffer> <silent> <D-r> :RustRun
onoremap <buffer> <silent> [[ :call rust#Jump('o', 'Back')
xnoremap <buffer> <silent> [[ :call rust#Jump('v', 'Back')
...
516
normal! zo
let s:l = 421 - ((39 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
421
...
516
normal! zo
let s:l = 340 - ((23 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
340
...
exe 'vert 4resize ' . ((&columns * 95 + 255) / 511)
exe 'vert 5resize ' . ((&columns * 127 + 255) / 511)
tabedit src/protocol/parsing/primitive.rs
set splitbelow splitright
wincmd _ | wincmd |
vsplit
wincmd _ | wincmd |
...
exe 'vert 3resize ' . ((&columns * 95 + 255) / 511)
exe 'vert 4resize ' . ((&columns * 95 + 255) / 511)
exe '5resize ' . ((&lines * 25 + 24) / 48)
exe 'vert 5resize ' . ((&columns * 127 + 255) / 511)
exe '6resize ' . ((&lines * 19 + 24) / 48)
exe 'vert 6resize ' . ((&columns * 127 + 255) / 511)
argglobal
nnoremap <buffer> <D-R> :RustRun! =join(b:rust_last_rustc_args)erust#AppendCmdLine(' -- ' . join(b:rust_last_args))
nnoremap <buffer> <silent> <D-r> :RustRun
onoremap <buffer> <silent> [[ :call rust#Jump('o', 'Back')
...
146
normal! zo
let s:l = 514 - ((15 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
514
...
wincmd w
argglobal
if bufexists('src/protocol/parsing/primitive.rs') | buffer src/protocol/parsing/primitive.rs | else | edit src/protocol/parsing/primitive.rs | endif
nnoremap <buffer> <D-R> :RustRun! =join(b:rust_last_rustc_args)erust#AppendCmdLine(' -- ' . join(b:rust_last_args))
nnoremap <buffer> <silent> <D-r> :RustRun
onoremap <buffer> <silent> [[ :call rust#Jump('o', 'Back')
xnoremap <buffer> <silent> [[ :call rust#Jump('v', 'Back')
...
679
normal! zo
let s:l = 686 - ((39 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
686
...
wincmd w
argglobal
if bufexists('src/protocol/parsing/io_input.rs') | buffer src/protocol/parsing/io_input.rs | else | edit src/protocol/parsing/io_input.rs | endif
nnoremap <buffer> <D-R> :RustRun! =join(b:rust_last_rustc_args)erust#AppendCmdLine(' -- ' . join(b:rust_last_args))
nnoremap <buffer> <silent> <D-r> :RustRun
onoremap <buffer> <silent> [[ :call rust#Jump('o', 'Back')
xnoremap <buffer> <silent> [[ :call rust#Jump('v', 'Back')
...
83
normal! zo
let s:l = 113 - ((38 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
113
...
83
normal! zo
let s:l = 53 - ((20 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
53
...
wincmd w
argglobal
if bufexists('src/protocol/rfb.rs') | buffer src/protocol/rfb.rs | else | edit src/protocol/rfb.rs | endif
nnoremap <buffer> <D-R> :RustRun! =join(b:rust_last_rustc_args)erust#AppendCmdLine(' -- ' . join(b:rust_last_args))
nnoremap <buffer> <silent> <D-r> :RustRun
onoremap <buffer> <silent> [[ :call rust#Jump('o', 'Back')
xnoremap <buffer> <silent> [[ :call rust#Jump('v', 'Back')
...
wincmd w
argglobal
if bufexists('src/protocol/parsing/parser_test.rs') | buffer src/protocol/parsing/parser_test.rs | else | edit src/protocol/parsing/parser_test.rs | endif
nnoremap <buffer> <D-R> :RustRun! =join(b:rust_last_rustc_args)erust#AppendCmdLine(' -- ' . join(b:rust_last_args))
nnoremap <buffer> <silent> <D-r> :RustRun
onoremap <buffer> <silent> [[ :call rust#Jump('o', 'Back')
xnoremap <buffer> <silent> [[ :call rust#Jump('v', 'Back')
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 18 - ((13 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
18
